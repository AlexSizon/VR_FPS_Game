...
public class Weapon : MonoBehaviour
{
    ...
    [AmmoType] public int ammoType = -1;
    ...
    [Header("Animation Clips")] public AnimationClip FireAnimationClip;
    public AnimationClip ReloadAnimationClip;

    [Header("Audio Clips")] public AudioClip FireAudioClip;
    public AudioClip ReloadAudioClip;

    [Header("Visual Settings")] public LineRenderer PrefabRayTrail;
    public bool DisabledOnEmpty;

    [Header("Visual Display")] public AmmoDisplay AmmoDisplay;
    ...
    public void Selected()
    {
        ...
        advancedSettings.ammoCountDisplay.text =
            WeaponInfoUI.Instance.WeaponClipContent.text + "/" + WeaponInfoUI.Instance.AmmoTypeCount.text;
    ...
    void RaycastShot()
    {
        ...
        RaycastHit hit;
        Ray r = new Ray(EndPoint.position, (-EndPoint.forward) * 0.5f + (Vector3) spread);
